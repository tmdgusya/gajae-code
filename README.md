...
For a Korean beginner walkthrough of Telegram setup, including BotFather token issuance, `gjc notify setup`, Telegram group creation, group Edit/Topics setup screenshots, `-100...` chat ids, and daemon verification, see [`docs/telegram-beginner-setup.md`](docs/telegram-beginner-setup.md).
