...
For a Korean beginner walkthrough of Telegram setup, including BotFather token issuance, Telegram group creation, group Edit/Topics setup screenshots, automatic `gjc notify setup --group` pairing, and daemon verification, see [`docs/telegram-beginner-setup.md`](docs/telegram-beginner-setup.md).
